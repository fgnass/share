import { createElement as lucide, Paperclip, Send, FileText, Download, ScanLine, X, Share2, Copy, Link2, Github, RefreshCw, ArrowLeft, FolderDown, FolderUp, FolderCheck, Folder } from "lucide";
import QRCode from "qrcode";
import { useEffect, useRef } from "preact/hooks";

const ICONS: Record<string, any> = {
  paperclip: Paperclip, send: Send, file: FileText, download: Download,
  scan: ScanLine, x: X, share: Share2, copy: Copy, link: Link2,
  github: Github, switch: RefreshCw, back: ArrowLeft,
